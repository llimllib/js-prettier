...
" case.
function! js#util#snippetcase(word) abort
  let l:snippet_case = get(g:, 'go_snippet_case_type', "snakecase")
  if l:snippet_case == "snakecase"
    return js#util#snakecase(a:word)
  elseif l:snippet_case == "camelcase"
    return js#util#camelcase(a:word)
  else
...
function! js#util#snakecase(word) abort
...
" Copied from tpope/vim-abolish
function! js#util#camelcase(word) abort
...
function! js#util#AddTags(line1, line2, ...) abort
  " default is json
  let l:keys = ["json"]
  if a:0
    let l:keys = a:000
  ...
  if ln1 == 0
    echon "js-prettier: " | echohl ErrorMsg | echon "cursor is outside the struct" | echohl None
    return
  endif
  ...
  for line in range(l:line1, l:line2)
    ...
    let word = js#util#snippetcase(l:matched)
